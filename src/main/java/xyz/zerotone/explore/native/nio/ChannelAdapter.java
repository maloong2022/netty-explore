package xyz.zerotone.explore.nio;
...
public abstract class ChannelAdapter extends Thread {
    ...
    private xyz.zerotone.explore.nio.ChannelHandler channelHandler;
        ...
        if (superclass == SocketChannel.class) {
            ...
            if (key.isConnectable()) {
                if (socketChannel.finishConnect()) {
                    channelHandler = new xyz.zerotone.explore.nio.ChannelHandler(socketChannel, charset);
    ...
    // 链接通知抽象类
    public abstract void channelActive(xyz.zerotone.explore.nio.ChannelHandler ctx);

    // 读取消息抽象类
    public abstract void channelRead(xyz.zerotone.explore.nio.ChannelHandler ctx, Object msg);
